...
adaptors:
  enabled:
    - example_telegram_adapter
    - example_discord_adapter 
    - example_mixin_adapter # enable the discord adapter
  example_mixin_adapter:
    driver: mixin        # use the mixin driver
    debug: false
    mixin:
      keystore: "YOUR_BASE64_ENCODED_KEYSTORE"
      whitelist:
...
```
https://supergroup.abc.com/auth/mixin/callback?code=1a82b78cc552f6af789058209a6279af7fa4e6507823dfb22935a0628b1da523
```
