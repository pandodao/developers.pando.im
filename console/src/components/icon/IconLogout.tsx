export const IconLogout = function () {
  ...
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path opacity="0.12" d="M10.6667 21C5.8802 21 2 16.9706 2 12C2 7.02944 5.8802 3 10.6667 3C12.2452 3 13.7252 3.43827 15 4.20404V19.796C13.7252 20.5617 12.2452 21 10.6667 21Z" fill="black"/>
